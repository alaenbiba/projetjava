...
public class client {
	...
	public String tostring(int code_clt,String nom, String prenom, String cin){
		return "le client de code" + code_clt + "de nom et prenom" + nom + " " + prenom + "et de code cin : " + cincl ; 
	}
